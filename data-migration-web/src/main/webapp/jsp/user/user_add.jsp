    ...
    <form class="form form-horizontal" id="form">
        <div class="row cl">
            <div class="inline">
                ...
                <div class="formControls col-xs-3" style="width: 20%;">
                    <input type="text" class="input-text radius" value="" name="usercode">
                </div>
            </div>
            <div class="inline">
        ...
        <div class="row cl">
            <div class="inline">
                ...
                <div class="formControls col-xs-3" style="width: 20%;">
                    <input type="text" class="input-text radius" value="" name="phonenumber">
                </div>
            </div>
            <div class="inline">
                <label class="form-label col-xs-4 col-sm-2"><strong>邮箱：</strong></label>
                <div class="formControls col-xs-3" style="width: 20%;">
                    <input type="text" class="input-text radius" value="" name="email">
                </div>
            </div>
        </div>
        <hr class="mt-10">
